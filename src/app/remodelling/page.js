...
export default function remodelling() {
  return (
    ...
    <div className={` ${barlow.className} w-[100%] h-[100vh] flex  items-center bg-[url('/renovations.webp')] bg-center bg-cover bg-no-repeat `}>
      ...
      <p className="max-w-4xl mt-8">Your space doesn't need to be torn down to be transformed. As trusted renovation contractors in Kenya, we specialise in giving tired homes and outdated commercial buildings a second life — without the chaos, the surprise costs, or the months of disruption that usually come with renovation work.</p>
      </div>
      </div>
      <div className="mt-20 mx-5">
        <div className="text-xs font-bold uppercase tracking-widest text-[#FFDF1B]">
          ...
          <p>Renovating an existing space comes with its own set of challenges, and our process is built around that reality. We begin with a thorough assessment, inspecting the existing structure, systems, and any hidden issues before we promise anything. From there, we develop renovation solutions that work within your building's constraints rather than fighting against them, and we put together a detailed proposal with transparent pricing covering the full scope of work. Once you approve the plan, we handle any required permits and coordinate logistics to keep disruption to a minimum, whether you're living in the home or running a business out of it. Our experienced crews then carry out the renovation efficiently, with attention to quality and cleanliness throughout. We close out every project with a final inspection, a proper clean up, and a walkthrough to confirm you're completely satisfied with the result</p>
      </div>
       <div className="mt-10 mx-5 flex justify-between flex-wrap">
         ...
         <div className="mt-20 mx-5">
          ...
          <p>We start by assessing what's already there, the structure, the systems, the constraints we have to work within. From that, we put together renovation plans and a transparent quote, so there's no scope creep once work begins. We handle any permits your county requires, then move into execution, working in phases where possible to keep your home or business livable throughout. Every renovation gets the same quality checks as a new build, because half measures on an upgrade aren't really an upgrade. When we're done, we walk the space with you, clean up properly, and stand behind the work with a warranty, just like we do on every project.</p>
