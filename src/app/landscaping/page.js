...
export default function landscaping() {
  return (
    <>
      <div className={`${barlow.className} relative flex min-h-[640px] items-center bg-[url('/cabro3.webp')] bg-center bg-cover bg-no-repeat px-5 py-28 sm:px-8 lg:min-h-screen`}>
        <div className="absolute inset-0 bg-gradient-to-r from-black/95 via-black/75 to-black/30" />
        <div className="relative z-10 w-full max-w-5xl">
          <h1 className="max-w-4xl text-4xl font-bold leading-tight sm:text-5xl lg:text-7xl"><span className="text-[#FFDF1B]">Cabro layers </span>and Landscaping Contractors in Kenya</h1>
